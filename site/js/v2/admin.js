...
(function () {
  ...
  const DEMO = {
    businesses: [
      ...
      { slug: 'example-tenant',     name: 'Example Tenant',     domain: 'www.example-tenant.com',    plan: 'base', analytics: { total_queries: 128, referral_clicks: 31,  referral_clicks_last_30_days: 18 } },
